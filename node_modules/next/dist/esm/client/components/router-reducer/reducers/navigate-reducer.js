...
export function navigateReducer(state, action) {
    ...
    return data.then((param)=>{
        ...
        // data is loaded.
        const updatedCanonicalUrl = canonicalUrlOverride && !prefetchValues.aliased ? createHrefFromUrl(canonicalUrlOverride) : href;
        ...
        for (const normalizedFlightData of flightData){
            ...
            if (newTree !== null) {
                ...
                seedData && isRootRender && postponed) {
                    const task = updateCacheNodeOnNavigation(currentCache, currentTree, treePatch, seedData, head, mutable.onlyHashChange);
                    if (task !== null) {
                    ...
                    if (prefetchValues.aliased && seedData) {
                        if (isRootRender) {
                            ...
                            fillCacheWithNewSubTreeDataButOnlyLoading(cache, currentCache, normalizedFlightData, prefetchValues);
                        }
                        applied = true;
                    } else if (prefetchValues.status === PrefetchCacheEntryStatus.stale && !mutable.onlyHashChange && !isFirstRead) {
