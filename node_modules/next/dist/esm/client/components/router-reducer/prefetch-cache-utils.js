...
function getExistingCacheEntry(url, kind, nextUrl, prefetchCache) {
    ...
    for (const maybeNextUrl of [
        ...
        if (process.env.NODE_ENV !== 'development' && url.search && kind !== PrefetchKind.FULL && entryWithoutParams && // We shouldn't return the aliased entry if it was relocated to a new cache key.
