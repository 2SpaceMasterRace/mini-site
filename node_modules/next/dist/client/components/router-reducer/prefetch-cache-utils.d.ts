 ...
 */
export declare function createPrefetchCacheEntryForInitialLoad({ nextUrl, tree, prefetchCache, url, data, }: Pick<ReadonlyReducerState, 'nextUrl' | 'tree' | 'prefetchCache'> & {
    url: URL;
