...
export declare function buildAppStaticPaths({ dir, page, distDir, configFileName, generateParams, isrFlushToDisk, cacheHandler, requestHeaders, maxMemoryCacheSize, fetchCacheKeyPrefix, nextConfigOutput, ComponentMod, isRoutePPREnabled, isAppPPRFallbacksEnabled, }: {
    dir: string;
    page: string;
    configFileName: string;
...
export declare function isPageStatic({ dir, page, distDir, configFileName, runtimeEnvConfig, httpAgentOptions, locales, defaultLocale, parentId, pageRuntime, edgeInfo, pageType, originalAppPath, isrFlushToDisk, maxMemoryCacheSize, nextConfigOutput, cacheHandler, pprConfig, isAppPPRFallbacksEnabled, }: {
    dir: string;
    page: string;
    distDir: string;
    configFileName: string;
...
type ReducedAppConfig = Pick<AppConfig, 'dynamic' | 'fetchCache' | 'preferredRegion' | 'revalidate' | 'experimental_ppr'>;
/**
 ...
 */
export declare function reduceAppConfig(segments: GenerateParamsResults): ReducedAppConfig;
